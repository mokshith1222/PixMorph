...
export function CssFormatter() {
  ...
  if (text.trim()) {
      try {
          formatted = beautify.css(text, { indent_size: 2 })
      } catch (e) {
          formatted = text
      }
  }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3 uppercase tracking-wider">Minified/Ugly CSS</label>
        <textarea
          value={text}
